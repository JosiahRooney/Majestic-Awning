...
<head>
  ...
  <link href='http://fonts.googleapis.com/css?family=Quicksand:300|Oswald' rel='stylesheet' type='text/css'>
  <script src="https://use.fontawesome.com/d71512d2b1.js"></script>
      ...
      <div class="container">
        <div class="row">
          <div class="title col-md-6">
            <h1><a href="/"><img class="logo" src="<?php echo get_template_directory_uri() . "/images/majestic-logo-left.png" ?>" alt=""> Majestic Awning &amp; Canopy</a></h1>
          </div>
          <div class="navigation col-md-6 row">
            <div class="col-xs-12">
              <?php wp_nav_menu('main_menu'); ?>
            </div>
            <p class="col-xs-12"><small class="license pull-right">Ca Contractors Lic #787399</small></p>
          </div>
        </div>
      </div>
    </header>
